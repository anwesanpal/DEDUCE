# Usage: python train_deduce_scene_office.py -a resnet18 -b=10 -j=4 -p=1000
...
parser = argparse.ArgumentParser(description='Training of Scene_Only model for the office environment')
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    torch.save(state, filename + '_latest_office.pth.tar')
    if is_best:
        shutil.copyfile(filename + '_latest_office.pth.tar', filename + '_best_office.pth.tar')
