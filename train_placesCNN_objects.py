# python train_placesCNN_objects.py -a resnet18 ./data/places365_standard_slam/ -b=10 -j=4 -p=1000
# python train_placesCNN_objects.py -a resnet18 ./data/places365_standard_slam/ -b=10 -j=4 -p=10 --resume=/home/users/a2pal/Work/places365/resnet18_best_slam.pth.tar
...
parser.add_argument('--cfg',default='yolov3/cfg/yolo_v3.cfg',
                    help='config file for yolo')
parser.add_argument('--weight',default='yolov3/yolov3.weights',
                    help='weight file for yolo')
parser.add_argument('--namesfile',default='yolov3/data/coco.names',
                    help='name file for yolo')
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    torch.save(state, filename + '_latest_combined.pth.tar')
    if is_best:
        shutil.copyfile(filename + '_latest_combined.pth.tar', filename + '_best_combined.pth.tar')
