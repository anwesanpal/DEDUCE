# Usage: python train_deduce_scene_attn.py -a wideresnet -b=10 -j=4 -p=1000
...
parser = argparse.ArgumentParser(description='Training of Scene+attn model')
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    torch.save(state, filename + '_latest_attn.pth.tar')
    if is_best:
        shutil.copyfile(filename + '_latest_attn.pth.tar', filename + '_best_attn.pth.tar')
